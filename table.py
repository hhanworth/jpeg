...
DC_luminance_table = [[0, '00'],
                    ...
                    [10, '11111110'],
                    [11, '111111110']]
DC_luminance_dict = dict(DC_luminance_table)                    
# 色度 直流
...
AC_luminance_table = [
                    ...
                    [ (15, 10), '1111111111111111111111110']]

ac_luminance_dict = {tuple_item[0]: tuple_item[1] for tuple_item in AC_luminance_table}


# 色度 交流
AC_chrominance_table = [[0, 0, '00'],
                        [0, 1, '01'],
                        [0, 2, '100'],
                        [0, 3, '1010'],
                        [0, 4, '11000'],
                        ...
                        [12, 3, '1111111111100'],
                        [12, 4, '1111111111101101'],
                        [12, 5, '1111111111101110'],
                        [12, 6, '1111111111101111'],
                        [12, 7, '1111111111110000'],
                        [12, 8, '1111111111110001'],
                        [12, 9, '1111111111110010'],
                        [12, 10, '1111111111110011'],
                        [13, 1, '11111111001'],
                        [13, 2, '1111111111110100'],
                        [13, 3, '1111111111110101'],
                        [13, 4, '1111111111110110'],
                        [13, 5, '1111111111110111'],
                        [13, 6, '1111111111111000'],
                        [13, 7, '1111111111111001'],
                        [13, 8, '1111111111111010'],
                        [13, 9, '1111111111111011'],
                        [13, 10, '1111111111111100'],
                        [14, 1, '11111111100000'],
                        [14, 2, '1111111111111101'],
                        [14, 3, '1111111111111110'],
                        [14, 4, '1111111111111111'],
